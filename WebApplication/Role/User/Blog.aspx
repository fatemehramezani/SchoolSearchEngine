<%@ Page Title="مدیریت بلاگ" Language="C#" MasterPageFile="~/App_MasterPage/PanelMasterPage.master" AutoEventWireup="true" Inherits="Admin_Blog" Codebehind="Blog.aspx.cs" %>
                ...
                <EditItemTemplate>
                    ...
                    <div class="row">
                        <asp:Label ID="DescriptionLabel" runat="server" Text="متن:" SkinID="Caption"></asp:Label>
                         <asp:CKEditor ID="DescriptionTextBox"  runat="server" Width="98%" EnableViewState="false" Height="400" />
                        
                         <asp:RequiredFieldValidator ID="BlogRequiredFieldValidator" runat="server" ControlToValidate="DescriptionTextBox"
                            Display="Dynamic" ErrorMessage="*" ValidationGroup="Update"></asp:RequiredFieldValidator>
                    </div>
                    <div class="row">
