<%@ Page Title="مدیریت صفحات پویا" Language="C#" MasterPageFile="~/App_MasterPage/PanelMasterPage.master" AutoEventWireup="true" Inherits="Admin_DynamicPage" Codebehind="DynamicPage.aspx.cs" %>
        ...
        <asp:View ID="EditView" runat="server">
            <asp:FormView ID="DynamicPageFormView" runat="server"  Width="90%" DataSourceID="DynamicPageEntityDataSource"
                ...
                <EditItemTemplate>
                    ...
                    <asp:TextBox ID="ContentTextBox" runat="server" Text='<%# Bind("Content") %>' Width="100%" TextMode="MultiLine" Rows="3" />
                                         
                    <asp:RequiredFieldValidator ID="DynamicPageRequiredFieldValidator" runat="server" ControlToValidate="ContentTextBox"
                        Display="Dynamic" ErrorMessage="*" ValidationGroup="Update"></asp:RequiredFieldValidator>
                    <br />
                ...
                <InsertItemTemplate>
                    ...
                    <asp:TextBox ID="ContentTextBox" runat="server" Text='<%# Bind("Content") %>' Width="100%" TextMode="MultiLine" Rows="3" />
                    <asp:RequiredFieldValidator ID="DynamicPageRequiredFieldValidator" runat="server" ControlToValidate="ContentTextBox" Display="Dynamic" ErrorMessage="*" ValidationGroup="Insert"></asp:RequiredFieldValidator>
                    <br />
                    <div style="float: left; padding: 10px;">
