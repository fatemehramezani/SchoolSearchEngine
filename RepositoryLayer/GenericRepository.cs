...
namespace RepositoryLayer
{
    ...
    public static class GenericRepository<T> where T : class
    {
        ...
        public static IQueryable<T> GetQuery(Func<T, bool> predicate = null)
        {
            IQueryable<T> result = entities.Set<T>();
            return (predicate == null ? result : result.Where(predicate)).AsQueryable();
        }
        ...
        public static T CreateUpdateItem(T item)
        {
            GeneralValidation(item);
